    ...
    features: [
      {
        ...
        geometry: {
          type: "Polygon",
          coordinates: [expect.arrayContaining([[5.020622298258249, 44.73758401718037]])],
        },
        properties: {
          id: expect.toBeAFeatureId(),
          remoteId: "1.3",
  ...
  multi: {
    ...
    features: [
      ...
      },
      {
        ...
        geometry: {
          type: "Polygon",
          coordinates: [expect.arrayContaining([[6.065424536564729, 47.68858541466545]])],
        },
        properties: {
          id: expect.toBeAFeatureId(),
          remoteId: "2.2",
      ...
      },
      {
        ...
        geometry: {
          type: "Polygon",
          coordinates: [expect.arrayContaining([[6.069309706237855, 47.6882033150393]])],
        },
        properties: {
          id: expect.toBeAFeatureId(),
          remoteId: "2.4",
