...
exports.up = async function (db) {
  await db.addColumn("cartobio_operators", "version_name", {
    type: "text",
  });
  await db.addColumn("cartobio_operators", "deleted_at", {
    type: "timestamp",
  });
  ...
  await db.changeColumn("cartobio_operators", "version_name", {
    type: "text",
    notNull: true,
  });
};
