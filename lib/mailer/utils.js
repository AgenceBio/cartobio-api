...
async function sendCertificationComplete (record, recipientEmail) {
  ...
  return sendMail({
    to: recipientEmail,
    subject: `CartoBio : votre attestation du parcellaire ${record.annee_reference_controle} est disponible`,
    html
  })
}
...
async function sendCertificationCompleteModifie (record, recipientEmail) {
  ...
  return sendMail({
    to: recipientEmail,
    subject: `CartoBio : votre attestation du parcellaire ${record.annee_reference_controle} a été mise à jour`,
    html
  })
}
