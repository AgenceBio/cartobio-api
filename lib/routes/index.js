...
const { decodeUserToken, enforceRecord, enforceOperator, verifyAgenceBioToken, enforceAnyFastifyDecorator, compareOperatorOutputAndToken } = require('../middlewares.js')
  ...
  schema: {
    body: {
      ...
      properties: {
        ...
        sort: {
          type: 'string',
          enum: ['nom', 'engagement_date', 'audit_date', 'statut'],
          default: 'audit_date'
        },
        order: {
          type: 'string',
