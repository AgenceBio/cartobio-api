...
const { decodeToken, enforceRecord, enforceToken, compareToken, trackRequest, compareOperatorOutputAndToken } = require('../middlewares.js')
const { getOperator, getRecord } = require('../providers/cartobio.js')
...
const routeWithRecordId = {
  ...
  preValidation: [
    enforceRecord({ queryFn: getRecord, fieldId: 'recordId' })
  ]
}
...
const routeWithOperatorId = {
  ...
  preValidation: [
    enforceRecord({ queryFn: getOperator, fieldId: 'operatorId' })
  ]
}
