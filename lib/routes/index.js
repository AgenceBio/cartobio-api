...
const { decodeToken, enforceToken, trackRequest, compareOperatorOutputAndToken } = require('../middlewares.js')
const env = require('../app.js').env()
const { JWT_SECRET, MATOMO_SITE_ID, MATOMO_TRACKER_URL, NODE_ENV, host, port, version } = env
