...
const { decodeUserToken, enforceAdminRole, enforceRecord, enforceRecordAndOperator, enforceOperator, verifyAgenceBioToken, enforceAnyFastifyDecorator, compareOperatorOutputAndToken, checkCertification } = require('../middlewares.js')
