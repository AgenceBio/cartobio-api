/**
 * @typedef {import('../providers/cartobio.js').CartoBioUser} CartoBioUser
 * @typedef {import('../providers/cartobio.js').DBOperatorRecord} DBOperatorRecord
 * @typedef {import('./features.js').CartoBioFeature} CartoBioFeature
 *
 */
