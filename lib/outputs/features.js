 ...
 *
 * @typedef {import('geojson').GeoJsonProperties} CartoBioFeatureProperties
 * @readonly {String} id
 * @readonly {String} createdAt
 * @readonly {String} updatedAt
 * @readonly {String} COMMUNE_LABEL
 * @property {String} COMMUNE
 * @property {CartobioCulture[]} cultures
 * @property {String} conversion_niveau
 * @property {String} engagement_date
 * @property {String} commentaire
 * @property {Object} annotations
 * @property {String} NOM
 * @property {String} PACAGE
 * @property {String} NUMERO_I
 * @property {String} NUMERO_P
 * @property {String[]} cadastre
 * @property {String[]} CPF - @deprecated
 * @property {String[]} TYPE - @deprecated
 * @property {String[]} variete - @deprecated
 *
 * @typedef {Object} CartobioCulture
 * @property {import('crypto').UUID} id
 * @property {String} CPF
 * @property {String=} TYPE
 * @property {String=} variete
 * @property {String=} surface - La surface en hectares
 * @property {String=} date_semis
 *
 * @typedef {import('geojson').Polygon} Polygon
 * @typedef {import('geojson').Feature<Polygon, CartoBioFeatureProperties>} CartoBioFeature
 * @typedef {import('geojson').FeatureCollection<Polygon, CartoBioFeatureProperties>} CartoBioFeatureCollection
 */
...
/**
 * @template {CartoBioFeature|CartoBioFeature[]|CartoBioFeatureProperties} M - the type of the target and source
 * @param {M} target
 * @param {M} source
 ...
 * @returns {any} - actually returns T but I don't know why it does not work
 */
