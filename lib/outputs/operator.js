...
async function populateWithRecords (operators) {
  ...
  const { rows } = await pool
    .query(/* sql */`SELECT DISTINCT ON (numerobio, audit_date) certification_state, audit_date, certification_date_debut, created_at, numerobio, metadata, record_id, updated_at
