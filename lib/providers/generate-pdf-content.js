 ...
 */
async function createPdfContent (numeroBio, recordId, parcelles, currentOperator) {
        ...
        <div class="left">
          ...
          <div class="ligne-header">
            <p>
              ...
              currentOperator.mixite === 'AB' ? '100% AB' :
              currentOperator.mixite === 'ABCONV' ? 'AB/En conversion' :
        ...
        <table>
          ...
          <tbody>
            ...
            <tr class="global-ligne">
              <td>${parcel.name || '-'}</td>
              <td>
                ${parcel.nbilot ? `Ilot ${parcel.nbilot || '-'} - Parcelle
                ${parcel.nbp || ''}` : parcel.refcad ? parcel.refcad.map((e) =>
                formatRefCad(e)).join(' ; ') : '-'}
              </td>
              <td>
              ...
              <td>
                ${parcel.conversion_niveau === 'CONV' ? 'Conventionnel' :
            ...
            <tr class="group-total">
              <td colspan="4">
                Niveau de conversion ${groupKey === 'CONV' ? 'conventionnel' :
                groupKey}
              </td>
