const fs = require('fs')
const { formatDate, getOptimalZoom, formatRefCad, calculateGlobalBoundingBox, launchStyleTab, drawParcelleHighlightOnMap, drawAllParcellesOnMap, mergeAndAddFooter, imageToBase64 } = require('./utils-pdf')
  ...
  <body>
      ...
      <div class="main-card">
        ...
        <div class="card-footer">
          <img class="sponsor" src="data:${mimeType};base64,${imageBio}" />
          <img class="sponsor" src="data:${mimeType};base64,${imageFeuille}" />
        </div>
      </div>
