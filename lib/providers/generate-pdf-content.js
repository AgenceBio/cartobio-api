...
async function createPdfContent (numeroBio, recordId, parcelles, currentOperator, pac) {
  ...
  try {
    ...
    const imageRP = fs.readFileSync('image-map/img/republique.png').toString('base64')
...
.main-card {
  ...
  <body>
      <div class="flex gap-image">
        <img class="sponsor" src="data:${mimeType};base64,${imageRP}" />
        <img class="sponsor" src="data:${mimeType};base64,${imageAB}" />
      </div>
      <br/>
