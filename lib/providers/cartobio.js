...
// Variables globales pour stocker les pages du navigateur
let browser
let tabs = []
...
async function generatePDF (numeroBio, recordId) {
  let currentOperator = await fetchOperatorByNumeroBio(numeroBio)
          ...
          <tbody>
            ...
            <tr class="global-ligne">
              ...
              <td>
                ...
                ${parcel.nbp || ''}` : parcel.refcad ? parcel.refcad : '-'}
              </td>
              <td>
