...
const { InvalidRequestApiError, MissingGeometryApiError, BadGatewayApiError, NotFoundApiError, ForbiddenApiError } = require('../errors.js')
  ...
  for (const feature of features) {
    if (!feature.geometry) {
      ...
      if (!partialUpdateRows.length) {
        throw new MissingGeometryApiError('Impossible de créer une parcelle sans donnée géographique.')
      }
