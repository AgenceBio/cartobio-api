  ...
  try {
    result = await client.query(
      /* sql */`
        ...
        VALUES ($1, $2, $3, $4, $5, $6, $7::date, $8::date, jsonb_build_array($9::jsonb), $10, $11,
        ...
        ON CONFLICT (numerobio, audit_date)
            ...
            SET (oc_id, oc_label, updated_at, metadata, certification_state, certification_date_debut, certification_date_fin, audit_history, audit_date, audit_notes, version_name)
                    = ($2, $3, $4, $5, coalesce($6, cartobio_operators.certification_state), coalesce($7, cartobio_operators.certification_date_debut), coalesce($8, cartobio_operators.certification_date_fin), (cartobio_operators.audit_history || coalesce($9, '[]')::jsonb), coalesce($10, cartobio_operators.audit_date), coalesce($11, cartobio_operators.audit_notes), coalesce($12, cartobio_operators.version_name))
        ...
        const { rows: partialUpdateRows } = await client.query(
          ...
          UPDATE cartobio_parcelles
              ...
              (coalesce($3, cartobio_parcelles.commune), coalesce($4, cartobio_parcelles.cultures),
               coalesce($5, cartobio_parcelles.conversion_niveau), coalesce($6, cartobio_parcelles.engagement_date),
