      ...
      const { rows } = await client.query(
        /* sql */`
          ...
          (record_id, id, geometry, commune, cultures, conversion_niveau, engagement_date, commentaire,
           ...
           reference_cadastre)
          VALUES ($1, $2, $3, $4, coalesce($5, '[]'::jsonb), $6, $7, $8, coalesce($9, '[]'::jsonb),
                  now(), now(), $10, $11, $12, $13, $14)
        ...
        [
          ...
          feature.properties.cultures ? JSON.stringify(feature.properties.cultures) : null,
          ...
          feature.properties.annotations ? JSON.stringify(feature.properties.annotations) : null,
      ...
      if (!rows.length) {
        await client.query(
          /* sql */`
            INSERT INTO cartobio_parcelles
            (record_id, id, geometry, commune, cultures, conversion_niveau, engagement_date, commentaire,
             auditeur_notes, annotations, created, updated, name, numero_pacage, numero_ilot_pac, numero_parcelle_pac,
             reference_cadastre)
...
if (process.env.NODE_ENV === 'test') {
  module.exports.evvClient = evvClient
}
