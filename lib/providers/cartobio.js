    ...
    const features = await Promise.all(record.parcelles
      ...
      .map(async (parcelle) => {
        ...
        try {
          ...
          // Il faut que la date d'engagement soit obligatoire pour les parcelles en conversion, soit en C1, C2 ou C3. (Donc différent de AB)
          if (conversionNiveau !== null && !conversionNiveau.includes('AB') && parcelle.dateEngagement === null) {
