...
/**
 * @typedef {import('./agence-bio').AgenceBioUserGroup} AgenceBioUserGroup
 * @typedef {import('./agence-bio').OrganismeCertificateur} OrganismeCertificateur
 * @typedef {import('../outputs/features').CartoBioFeature} CartoBioFeature
 * @typedef {import('../outputs/features').CartoBioFeatureCollection} CartoBioFeatureCollection
 * @typedef {import('../outputs/features').CartoBioFeatureProperties} CartoBioFeatureProperties
 * @typedef {import('../outputs/record').NormalizedRecord} NormalizedRecord
 * @typedef {import('../outputs/history').HistoryEntry} HistoryEntry
 ...
 * @property {CartoBioFeatureCollection} parcelles
...
/**
 * @typedef {Object} CartoBioUser
 * @property {number} id
 * @property {string} nom
 * @property {string} prenom
 * @property {AgenceBioUserGroup[]} groups - this is the part where we still rely on Agence Bio abstractions
 * @property {AgenceBioUserGroup} mainGroup
 */

/**
 * @typedef {CartoBioUser} CartoBioOCUser
 ...
 * @property {InputApiParcelle[]} parcelles
 */

/**
 * @typedef {Object} InputApiParcelle
 ...
 * @property {InputApiCulture[]} culture
 * @property {InputApiCulture[]=} cultures
 */

/**
 * @typedef {Object} InputApiCulture
