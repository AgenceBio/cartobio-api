 ...
 */
async function launchStyleTab (browser, { name, styleUrl }, timeout = 30000) {
  ...
  try {
    ...
    await page.close()
    throw new Error(`Timeout lors du chargement de la page pour le style ${name}: ${error.message}`)
  }
}
