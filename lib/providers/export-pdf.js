...
async function generatePDF (numeroBio, recordId) {
  ...
  await page.pdf({
    path: `${numeroBio}-${recordId}-${dateTraitement}-2.pdf`,
    format: 'A4',
    landscape: false,
...
`
  ...
  await page.pdf({
    path: `${numeroBio}-${recordId}-${dateTraitement}-1.pdf`,
    format: 'A4',
    landscape: true,
    printBackground: true,
    margin: {
  ...
  await page2.pdf({
    path: `${numeroBio}-${recordId}-${dateTraitement}-0.pdf`,
    format: 'A4',
    landscape: true,
    printBackground: true,
    pageRanges: '1',
  ...
  const pdfFiles = [`${numeroBio}-${recordId}-${dateTraitement}-0.pdf`, `${numeroBio}-${recordId}-${dateTraitement}-1.pdf`, `${numeroBio}-${recordId}-${dateTraitement}-2.pdf`]
