...
describe('test search with filter', () => {
  ...
  test('no filter, records with no notifications or production filtered', async () => {
    ...
    expect(res.pagination).toEqual({ page: 1, page_max: 2, total: 6 })
  })
  ...
  test('no filter, records with no notifications filtered, page 2', async () => {
    ...
    expect(res.pagination).toEqual({ page: 2, page_max: 2, total: 6 })
  })
  ...
  test('sort result', async () => {
    ...
    expect(resNomAsc.pagination).toEqual({ page: 1, page_max: 1, total: 6 })
    ...
    expect(resNomAsc.records[2].nom).toEqual('Françoise')
    expect(resNomAsc.records[3].nom).toEqual('Gregoire')
    expect(resNomAsc.records[4].nom).toEqual('- Joël')
    expect(resNomAsc.records[5].nom).toEqual('3Denise')
    ...
    expect(resDateAuditDesc.records[2].nom).toEqual('Françoise')
    expect(resDateAuditDesc.records[3].nom).toEqual('Gregoire')
    expect(resDateAuditDesc.records[4].nom).toEqual('- Joël')
    expect(resDateAuditDesc.records[5].nom).toEqual('3Denise')
    expect(resDateAuditDesc.records[5].max_audit_date == null).toEqual(true)

    expect(resDateAuditAsc.records[5].max_audit_date).toEqual('2023-09-07')
    expect(resDateAuditAsc.records[4].max_audit_date).toEqual('2022-05-01')
    expect(resDateAuditAsc.records[3].max_audit_date == null).toEqual(true)
    expect(resDateAuditAsc.records[0].max_audit_date == null).toEqual(true)
    expect(resDateAuditAsc.records[0].nom).toEqual('Françoise')
    expect(resDateAuditAsc.records[1].nom).toEqual('Gregoire')
    expect(resDateAuditAsc.records[2].nom).toEqual('- Joël')
    expect(resDateAuditAsc.records[3].nom).toEqual('3Denise')
  })
})
