...
const { sendCertificationComplete } = require('../mailer/utils.js')
...
beforeEach(() => { jest.clearAllMocks(); jest.spyOn(sendCertificationComplete).mockResolvedValue({ messageId: 'test' }) })
